...
- (void)viewDidLoad
{
  ...
  self.creditArray = @[
       @"Version 2.9 of Yale Mobile is developed by Hengchu Zhang (CC '15) and designed by Danqing Liu (CC '13) with love in 2014 for fellow Yalies. Jenny Allen (TC '16), Charly Walther (BK '16) and Minh Tri Pham (JE '17) contributed during the development of this release. We would like to thank everyone who sent us feedback during the past year, and to thank President Salovey for the support in making this application.\n\nAs both developers of the app are Hounies, Yale Mobile 2.9 is dedicated to Leslie Woodard, the beloved Dean of Calhoun College who passed away in October 2013.",
